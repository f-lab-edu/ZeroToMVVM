...
class MainActivity : AppCompatActivity() {
    ...
    companion object {
        const val TO_DETAIL_SELECTED_ITEM_INDEX_EXTRA = "TO_DETAIL_SELECTED_ITEM_INDEX_EXTRA"
        const val TO_DETAIL_SELECTED_ITEM_STATE_EXTRA = "TO_DETAIL_SELECTED_ITEM_STATE_EXTRA"
    }
}